...
| **Dynamic Scoring**               | <Icon name="approve-check" color="green" size="1.5rem" /> | <Icon name="rocket" color="orange" size="1.2rem" />       |
| **Individualized Infrastructure** | _Enterprise Only_                                         | <Icon name="rocket" color="orange" size="1.2rem" />       |
| **Advanced User Authentication**  | _Enterprise Only_                                         | <Icon name="approve-check" color="green" size="1.5rem" /> |
| **King of the Hill**              | _Enterprise Only_                                         | <Icon name="star" color="yellow" size="1.5rem" />         |
| **Evolving Hints**                | <Icon name="close" color="red" size="1.5rem" />           | <Icon name="star" color="yellow" size="1.5rem" />         |
| **First Blood**                   | <Icon name="close" color="red" size="1.5rem" />           | <Icon name="star" color="yellow" size="1.5rem" />         |
| **Anti-Cheat**                    | <Icon name="close" color="red" size="1.5rem" />           | <Icon name="rocket" color="orange" size="1.2rem" />       |

> <Icon name="star" color="yellow" size="1.5rem" /> Features marked with a yellow star are currently planned.
> <Icon name="rocket" color="orange" size="1.2rem" /> Features marked with a orange rocket are currently under active development.
> <Icon name="approve-check" color="green" size="1.5rem" /> Features marked with a green checkmark are implemented.

So you now know that you want to use CTF-Citadel, but how do you get started? Well, let's take a look at that by clicking on the button below.
